                                ...
                                <tr>      
                                    <td colspan="7" class="text-end fw-bold">
                                            <div class="d-flex flex-row-reverse ">
                                                <input type="text" name="location" class="form-control  p-3 w-25" required value="{{$order->location}}" readonly>
                                                <label for="location" class="form-label p-3">Location :</label>
                                                <input type="text" name="received" class="form-control  p-3 w-25 disable" required readonly value="{{$order->amount_received}}">
