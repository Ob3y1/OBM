...
@section('content')
    <nav class="navbar bg-body-tertiary ">
        <div class="container-fluid  justify-content-md-between">
            ...
            <div class="d-flex"><a href="{{ route('purchase', $user_id) }}" class=" me-2 btn btn-outline-primary" data-bs-toggle="tooltip"
                            ...
                            <tbody>
                                ...
                                @foreach($orderItems as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <form action="{{ route('deleteitemfrompur', $item->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                            ...
                            <tfoot>
                                <tr>  
                                    <td colspan="8" class="text-end fw-bold">
                                        <form action="{{ route('completepur') }}" method="POST">
                                        @csrf
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('deletepur', $idp) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
