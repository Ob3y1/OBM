    ...
    <main class="d-flex flex-nowrap">
      <div id="sidebarId" class="sidebar position-relative d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary ">
        <div class="d-flex align-items-center mb-0 me-md-auto link-body-emphasis text-decoration-none">
          <img src="{{ asset('images/Mood Board 3000x2000 px1.png') }}" class="doera" width="45px" onclick="toggleSidebar1()" >
          <span class="fs-4 sidebar-text ms-2">OBM</span>
        </div>
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          <li class="nav-item">
            <a href="{{route('dashmony')}}" class=" nav-link link-body-emphasis" aria-current="page">
          ...
          <li class="nav-item">
            <a href="{{route('partnerships')}}" class="  nav-link link-body-emphasis">
              <svg class="bi pe-none me-2" width="16" height="16">
                <use xlink:href="#mony" />
              </svg>
              <span class="sidebar-text"> Partnerships management</span>
            </a>
          </li>
          <hr style="margin: 5px 15px 5px 5px ; ">
          <li class="nav-item">
            <a href="{{route('profile')}}" class="  nav-link link-body-emphasis">
              <svg class="bi pe-none me-2" width="16" height="16">
          ...
          <hr style="margin: 5px 15px 5px 5px ; ">
          <li class="nav-item">
            <a href="{{route('category')}}" class="nav-link link-body-emphasis">
              <svg class="bi pe-none me-2" width="16" height="16">
          ...
          <hr style="margin: 5px 15px 5px 5px ; ">
          <li class="nav-item">
            <a href="{{route('sales')}}" class="nav-link link-body-emphasis">
              <svg class="bi pe-none me-2" width="16" height="16">
                <use xlink:href="#grid" />
              </svg>
              <span class="sidebar-text">Sales management</span>
            </a>
          </li>
          <hr style="margin: 5px 15px 5px 5px ; ">
          <li class="nav-item">
            <a href="{{route('purchasing')}}" class="nav-link link-body-emphasis">
              <svg class="bi pe-none me-2" width="16" height="16">
                <use xlink:href="#bag" />
              </svg>
              <span class="sidebar-text">Purchasing management</span>
            </a>
          </li>
          <hr style="margin: 5px 15px 5px 5px ; ">
        </ul>
        ...
        <div class="dropdown">
          <a href="#" class="d-flex align-items-center link-body-emphasis text-decoration-none dropdown-toggle"
            ...
            <img src="{{ asset('images/Mood Board 3000x2000 px1.png') }}" alt="" width="40" height="40" class="rounded-circle me-2">
