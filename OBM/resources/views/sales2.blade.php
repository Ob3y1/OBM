...
@section('content')
    <nav class="navbar bg-body-tertiary ">
        <div class="container-fluid  justify-content-md-between">
            ...
            <div class="d-flex"><a href="{{ route('order', $user_id) }}" class=" me-2 btn btn-outline-primary" data-bs-toggle="tooltip"
                                    ...
                                    <td colspan="7" class="text-end fw-bold">
                                        ...
                                        @csrf
                                            <div class="d-flex flex-row-reverse">
                                                <input type="text" name="location" class="form-control w-50 p-3" required>
                                        ...
                                        <td class="text-end">
                                        <form action="{{ route('deleteorder', $ido) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
